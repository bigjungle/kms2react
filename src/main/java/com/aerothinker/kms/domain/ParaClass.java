...
public class ParaClass implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties("paraClasses")
    ...
    public ParaClass createTime(Instant createTime) {
    ...
    public ParaClass modifyTime(Instant modifyTime) {
    ...
    public ParaClass createdUser(ParaUser paraUser) {
    ...
    public ParaClass modifiedUser(ParaUser paraUser) {
    ...
    public ParaClass verifiedUser(ParaUser paraUser) {
