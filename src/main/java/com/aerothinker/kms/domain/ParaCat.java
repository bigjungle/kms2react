...
public class ParaCat implements Serializable {
    ...
    public ParaCat createTime(Instant createTime) {
    ...
    public ParaCat modifyTime(Instant modifyTime) {
    ...
    public ParaCat createdUser(ParaUser paraUser) {
    ...
    public ParaCat modifiedUser(ParaUser paraUser) {
    ...
    public ParaCat verifiedUser(ParaUser paraUser) {
